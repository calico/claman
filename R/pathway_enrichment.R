...
#' )
#' @export
find_pathway_enrichments <- function(mzroll_list,
                                     regression_significance,
                                     pathway_list,
...
expand_gsea_output <- function(enrichment_by_term,
                               enrichment_table,
                               pathway_list,
                               additional_grouping_vars) {
...
calculate_pathway_enrichment_gsea <- function(term_data,
                                              pathway_list,
                                              fdr_cutoff = 0.1) {
...
calculate_pathway_enrichment_fisher <- function(term_data,
                                                pathway_list,
                                                fdr_cutoff = 0.1) {
  checkmate::assertDataFrame(term_data)
  checkmate::assertList(pathway_list, names = "unique")
