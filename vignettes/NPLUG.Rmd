...
Have normalized for month and extraction method, we can look at the results as another heatmap.
...
```{r met_examples, fig.width = 6, fig.height = 6}
...
```{r top_enrichments}
plot(enrichments$enrichment_plots[["limitationNH4"]])
